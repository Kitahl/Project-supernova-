...
class ExpectedBaseHeadContractTests(unittest.TestCase):
    ...
    def test_current_historical_state_remains_schema_valid_without_expected_base_head(self):
        ...
        self.assertNotIn("expected_base_head", current)
        self.assertEqual(list(Draft202012Validator(schema).iter_errors(current)), [])
