...
SEED_INSTALL='f5127b87365afeffbab0fc7aef90f8df8aa4d3d4'
SEED_POLICY_BLOB='724df89b680148381aa987a242af04cfe7c4c676'
...
class RootEpoch6RepairTests(unittest.TestCase):
 ...
 def test_countable_control_v20_freezes_epoch6_repair_surface(self):
  ...
  required={'config/root_epoch6_repair_seed_v25.json','config/root_epoch6_repair_epoch_v25.json','scripts/reconcile_root_epoch6_repair_seed.py','tests/test_root_epoch6_repair_seed.py','tests/test_root_epoch6_repair.py','scripts/reconcile_v25_admission.py','scripts/reconcile_open_prs.py','scripts/reconcile_authority_bootstrap.py','scripts/diagnose_authority_bootstrap.py'}
