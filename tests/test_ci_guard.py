...
SCRIPT=pathlib.Path(__file__).resolve().parents[1]/"scripts"/"ci_guard.py";SPEC=importlib.util.spec_from_file_location("ci",SCRIPT);ci=importlib.util.module_from_spec(SPEC);SPEC.loader.exec_module(ci)
