...
class BootstrapRootTcbAndHeadBindingTests(unittest.TestCase):
    ...
    def test_non_tcb_support_path_is_not_rejected_as_root_drift(self):
        mod = load_bootstrap_module()
        self.assertNotIn("docs/PROJECT_SUPERNOVA_REV5_CANDIDATE.md", mod.bootstrap_root_paths(ROOT))
    ...
    def test_privileged_workflow_passes_immutable_event_head_base_and_run(self):
