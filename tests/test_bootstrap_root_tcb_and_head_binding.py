...
class BootstrapRootTcbAndHeadBindingTests(unittest.TestCase):
 def test_transitive_write_capable_admission_tcb_is_root_protected(self):
  ...
  expected={
   ...
   'config/t0_trust_repair_seed_v25.json','config/root_epoch6_repair_seed_v25.json','config/root_epoch6_repair_epoch_v25.json','config/root_epoch7_repair_seed_v25.json','config/root_epoch7_repair_epoch_v25.json','config/validator_environment_v25.json','config/generation_delta_policy_v25.json',
   'scripts/assert_validator_environment.py','scripts/generation_delta_guard.py','scripts/reconcile_authority_bootstrap.py','scripts/reconcile_open_prs.py','scripts/reconcile_root_rotation_seed.py','scripts/reconcile_t0_trust_repair_seed.py','scripts/reconcile_root_epoch6_repair_seed.py','scripts/reconcile_root_epoch7_repair_seed.py','scripts/reconcile_branch_statuses.py','scripts/check_lane_liveness.py','scripts/validate_bus.py','scripts/parent_lineage_guard.py','scripts/transition_guard.py',
   '.github/workflows/supernova-authority-bootstrap.yml','.github/workflows/supernova-bootstrap-completion-reconcile.yml','.github/workflows/supernova-pr-target-admission.yml','.github/workflows/supernova-comment-admission.yml','.github/workflows/supernova-open-pr-reconciler.yml','.github/workflows/supernova-root-rotation-seed.yml','.github/workflows/supernova-t0-trust-repair-seed.yml','.github/workflows/supernova-root-epoch6-repair-seed.yml','.github/workflows/supernova-root-epoch7-repair-seed.yml','.github/workflows/supernova-branch-reconciler.yml','.github/workflows/supernova-liveness-monitor.yml','requirements-validation.lock'
  }
 ...
 def test_each_privileged_class_is_rejected_as_root_drift(self):
  ...
  for path in ('scripts/reconcile_open_prs.py','scripts/reconcile_authority_bootstrap.py','scripts/assert_validator_environment.py','scripts/reconcile_root_epoch6_repair_seed.py','scripts/reconcile_root_epoch7_repair_seed.py','config/root_epoch6_repair_seed_v25.json','config/root_epoch6_repair_epoch_v25.json','config/root_epoch7_repair_seed_v25.json','config/root_epoch7_repair_epoch_v25.json','config/validator_environment_v25.json','config/generation_delta_policy_v25.json','.github/workflows/supernova-pr-target-admission.yml','.github/workflows/supernova-bootstrap-completion-reconcile.yml','.github/workflows/supernova-root-epoch6-repair-seed.yml','.github/workflows/supernova-root-epoch7-repair-seed.yml','requirements-validation.lock'):
 ...
 def test_epoch7_policy_is_the_current_bootstrap_invariant_and_epoch6_is_predecessor(self):
  ...
  self.assertEqual(admission['root_tcb_epoch'],7)
  self.assertEqual(bootstrap['root_tcb_epoch_required'],7)
  self.assertEqual(epoch['epoch'],7)
  self.assertEqual(epoch['previous_epoch_blob'],'5a087dead0572390565bfe8bfb8f2ce69a80fc7c')
