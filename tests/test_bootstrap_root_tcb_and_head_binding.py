...
class BootstrapRootTcbAndHeadBindingTests(unittest.TestCase):
 ...
 def test_each_privileged_class_is_rejected_as_root_drift(self):
  ...
  for path in ('scripts/reconcile_open_prs.py','scripts/reconcile_authority_bootstrap.py','scripts/assert_validator_environment.py','scripts/strict_json.py','scripts/reconcile_root_epoch6_repair_seed.py','scripts/reconcile_root_epoch7_repair_seed.py','scripts/reconcile_root_epoch8_status_writer_repair_seed.py','scripts/reconcile_root_epoch9_integrity_repair_seed.py','config/root_epoch6_repair_seed_v25.json','config/root_epoch6_repair_epoch_v25.json','config/root_epoch7_repair_seed_v25.json','config/root_epoch7_repair_epoch_v25.json','config/root_epoch8_status_writer_repair_seed_v25.json','config/root_epoch8_status_writer_repair_epoch_v25.json','config/root_epoch9_integrity_repair_seed_v25.json','config/root_epoch9_integrity_repair_epoch_v25.json','config/validator_environment_v25.json','config/generation_delta_policy_v25.json','.github/workflows/supernova-pr-target-admission.yml','.github/workflows/supernova-bootstrap-completion-reconcile.yml','.github/workflows/supernova-root-epoch6-repair-seed.yml','.github/workflows/supernova-root-epoch7-repair-seed.yml','.github/workflows/supernova-root-epoch8-status-writer-repair-seed.yml','.github/workflows/supernova-root-epoch9-integrity-repair-seed.yml','requirements-validation.lock'):
 ...
 def test_epoch9_policy_is_current_and_epoch8_is_predecessor(self):
  ...
  self.assertEqual(admission['root_tcb_epoch'],9)
  self.assertEqual(bootstrap['root_tcb_epoch_required'],9)
  self.assertEqual(epoch['epoch'],9)
  self.assertEqual(epoch['previous_epoch_blob'],'b98b3378ad90e9c35fd02017ea3a4a0f21320c52')
