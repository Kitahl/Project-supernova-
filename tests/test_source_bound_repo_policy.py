...
class SourceBoundRepoPolicyTests(unittest.TestCase):
    ...
    def test_repo_policy_binds_three_contexts_to_exact_status_app_principal(self):
        ...
        self.assertEqual(policy["required_status_source_integration_ids"], [4697060])
        self.assertEqual(
            policy["required_status_source_creator_logins"],
            ["project-supernova-status-authority[bot]"],
        )
